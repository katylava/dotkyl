...
argument-hint: "[off|quiet|default|verbose]"
---
...
- `quiet` — speak only at decision points and forks: where you choose an approach, or where you stop and need the user to decide (e.g. you ask a blocking question or hit an auto-mode classifier block). The user hears the *why* and can redirect.
