...
alias teatimes="nvim ~/Documents/teatimes.txt"
alias unstuck="nvim ~/Documents/unstuck.md"
...
alias freecell='python3 ~/code/Personal/pyfreecell/freecell.py -w6'
alias jira='jira-cli'
alias k='kubectl'
alias kc='kubectl config unset current-context'
alias kcc='kubectl config current-context'
alias kd='ksc dev-gke'
alias kgetimage='k describe pods | grep "tags.datadoghq.com/version=" | uniq | cut -d= -f2'
...
alias orm='PYTHONPATH=$HOME/.pyhooks orm'
